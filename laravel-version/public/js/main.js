    ...
    window.loadUpcomingLessons = function () {
      ...
      function render(lessons) {
        if (!lessons || !lessons.length) {
          container.innerHTML = '<div class="ph-upcoming-empty">Aucun cours à venir pour le moment.</div>';
          return;
        }
        ...
        lessons.forEach(function (lesson) {
          ...
          html += '<a class="ph-upcoming-card" href="' +
            ...
            '<div class="ph-upcoming-body">' +
              ...
              '</div>' +
            '</div>' +
            '<span class="ph-upcoming-cta">Réserver →</span>' +
          '</a>';
        });
        container.innerHTML = html;
      }
      ...
      fetch('/api/v1/lessons')
        ...
        .catch(function () {
          container.innerHTML = '<div class="ph-upcoming-empty">Impossible de charger les cours pour le moment. Veuillez réessayer plus tard.</div>';
        });
    };
