...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'phone', 'value' => '+1 (819) 271-9783', 'type' => 'text', 'group' => 'contact'],
            ['key' => 'google_rating', 'value' => '4.9', 'type' => 'text', 'group' => 'home'],
            ['key' => 'cta_title', 'value' => 'Prêt à commencer votre parcours ?', 'type' => 'text', 'group' => 'home'],
            ['key' => 'cta_description', 'value' => "Rejoignez plus de 950 étudiants qui nous font confiance pour leur préparation linguistique.", 'type' => 'text', 'group' => 'home'],
            ['key' => 'cta_button_text', 'value' => 'Créer mon compte gratuit', 'type' => 'text', 'group' => 'home'],
        ];
